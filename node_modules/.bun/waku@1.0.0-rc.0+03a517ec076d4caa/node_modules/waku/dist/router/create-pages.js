...
import { unstable_createCustomError as createCustomError, unstable_getGrouplessPath as getGrouplessPath } from '../minimal/server.js';
import { ErrorBoundary } from '../router/client.js';
import { countSlugsAndWildcards, parseExactPath } from './create-pages-utils/path-spec.js';
import { unstable_defineRouter } from './define-router.js';
import { getPathMapping, parsePathWithSlug, pathSpecAsString } from './isomorphic-utils/path-spec.js';
...
export const createPages = (fn, options)=>{
    ...
    const renderRoot = ()=>/*#__PURE__*/ createElement(rootItem ? rootItem.component : DefaultRoot, null, /*#__PURE__*/ _jsx(Children, {}));
