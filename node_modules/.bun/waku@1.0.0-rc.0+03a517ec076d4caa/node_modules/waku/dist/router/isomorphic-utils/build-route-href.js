 ...
 */ export const buildRouteHref = (target, resolveCodec)=>{
    ...
    if (search !== undefined) {
        ...
        if (!codec) {
            throw new Error(`Cannot serialize "search" for "${to}": no search codec resolved. Provide it via <Unstable_SearchCodecsProvider> in a module rendered on every page (e.g. your root layout) so navigation can serialize it.`);
        }
...
//# sourceMappingURL=build-route-href.js.map