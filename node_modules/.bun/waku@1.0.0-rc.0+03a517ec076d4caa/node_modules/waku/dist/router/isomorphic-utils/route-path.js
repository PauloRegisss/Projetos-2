...
export const getRouteSlotId = (path)=>ROUTE_SLOT_ID_PREFIX + path;
export const getSliceSlotId = (id)=>SLICE_SLOT_ID_PREFIX + id;
export const isRouteSlotId = (slotId)=>slotId.startsWith(ROUTE_SLOT_ID_PREFIX);
export const isSliceSlotId = (slotId)=>slotId.startsWith(SLICE_SLOT_ID_PREFIX);
